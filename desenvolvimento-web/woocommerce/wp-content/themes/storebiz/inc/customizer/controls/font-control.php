...
class Storebiz_Icon_Picker_Control extends WP_Customize_Control
{

  private $icons = false;

  public function __construct( $manager, $id, $args = array(), $options = array() ) {
    $this->icons = $this->Storebiz_get_icons();
            ...
            <select <?php $this->link(); ?> style="font-family: 'FontAwesome', Arial;">
                <?php
                    foreach ( $this->icons as $k => $v ) {
                        $sanitized_key = esc_attr( $k );
                        $sanitized_value = esc_html( $v );

                        printf( '<option value="%s" %s>%s</option>', $sanitized_key, selected( $this->value(), $k, false ), $sanitized_value );
                    }
                ?>
            </select>
        </label>
